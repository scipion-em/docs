...
.. toctree::
   ...
   xmipp3.protocols.protocol_angular_alignment_zernike3d
   xmipp3.protocols.protocol_angular_graph_consistency
   xmipp3.protocols.protocol_apply_alignment
   xmipp3.protocols.protocol_apply_deformation_zernike3d
   ...
   xmipp3.protocols.protocol_classify_kmeans2d
   ...
   xmipp3.protocols.protocol_kmeans_clustering
   ...
   xmipp3.protocols.protocol_movie_correlation
   ...
   xmipp3.protocols.protocol_particle_boxsize
   ...
   xmipp3.protocols.protocol_pdb_deform_zernike3d
   ...
   xmipp3.protocols.protocol_reconstruct_heterogeneous
