...
----------------------
    ...
    **PDB**: `link to C7 model </docs/docs/images/Conventions/Symmetry/c7.pdb>`_
...
------------------------
    ...
    **PDB**: `link to D7x model </docs/docs/images/Conventions/Symmetry/d7x.pdb>`_
...
---------------
    ...
    **PDB**: `link to T222 model </docs/docs/images/Conventions/Symmetry/t222.pdb>`_
    ...
    **PDB**: `link to Tz3 </docs/docs/images/Conventions/Symmetry/tz3.pdb>`_
...
--------------
    ...
    **PDB**: `link to O model </docs/docs/images/Conventions/Symmetry/o.pdb>`_
...
---------------
   ...
   **PDB**: `link to I222 model </docs/docs/images/Conventions/Symmetry/i222.pdb>`_
   ...
   **PDB**: `link to I222r model </docs/docs/images/Conventions/Symmetry/i222r.pdb>`_
   ...
   **PDB**: `link to In25 model </docs/docs/images/Conventions/Symmetry/in25.pdb>`_
   ...
   **PDB**: `link to In25r model </docs/docs/images/Conventions/Symmetry/in25r.pdb>`_
   ...
   **PDB**: `link to I2n3 model </docs/docs/images/Conventions/Symmetry/i2n3.pdb>`_
