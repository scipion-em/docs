 ...
 *Guide*:
 `Picking tutorial <tutorials/tomo/Picking_tutorial/tutorial-picking>`_
 ...
 *Guide*:
 `Denoising, Membrane Segmentation and Annotation and Directional Picking <denoising_mbSegmentation_pysegDirPicking/tomosegmemTV_pySeg_workflow>`_
