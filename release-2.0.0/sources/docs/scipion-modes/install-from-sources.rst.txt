...
Note: We have observed that when using precompiled bundles for Scipion and Xmipp, libjbig.so.0 is not found.
However, OpenSUSE contains libjbig.so.2 and it is also valid. Therefore, please copy one to the other by
  
::

    sudo cp /usr/lib64/libjbig.so.2 /usr/lib64/libjbig.so.0
