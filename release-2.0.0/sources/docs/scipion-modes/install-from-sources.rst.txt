...
.. toctree::
    ...
    install-from-sources#step-3-configure-and-install
    install-from-sources#step-4-installing-xmipp3-and-other-em-plugins
    install-from-sources#step-5-cleaning-up-optional
