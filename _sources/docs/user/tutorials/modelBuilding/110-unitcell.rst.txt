...
-  | Validation protocols to select the best *model* of the human
   ...
   | Validate the new combined structure generated is recommendable
     ...
     unit, generated by combining *metHgb* :math:`\alpha` and :math:`\beta` subunits. Appendix :ref:`Solutions <app:solutions>` (**Question**\ `11 <buildingunitcell>`__\ **\ \_1**) contains a statistics table for the unit cell *model* (Table 8). We can try to improve those statistics by additional refinement processes. By
