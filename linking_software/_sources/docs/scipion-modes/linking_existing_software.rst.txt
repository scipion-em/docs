...
install relion-3.1 you'll end up with a folder relion-3.1 at EN_ROOT folder (by default SCIPION_HOME/software/em).

In some cases, the plugins need to know the version of the binary behind and is using this pattern to infer the version from the folder name (relion-*3.1* in this case)
...
::
    ...
    ln -s path/to/my/optimeized/relion3.1/ SCIPION_HOME/software/em/relion-3.1
